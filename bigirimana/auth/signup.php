...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($check)>0) {
        ...
        $insert=mysqli_query($conn,"INSERT INTO users(username,password)VALUE('{$uname}','{$pass}')");
        if ($insert==true) {
...
<img src="../image/icon.png" alt=""><span>Xwisdom</span>_TVET
    ...
    <div class="container">
    <div class="text">
<h1><marquee drection="left">XWISDOM_TVET SCHOOL</marquee></h1>
...
practical experience through internships or apprenticeships.
    ...
    <form action="" method="post">
        ...
        <button type="submit" value="submit" name="submit">signup</button><br>
